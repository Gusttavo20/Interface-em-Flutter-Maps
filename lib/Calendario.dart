...
class CalendarioState extends StatefulWidget {
  ...
  @override
  State<CalendarioState> createState() => _CalendarDatePickerState();
}

class _CalendarDatePickerState extends State<CalendarioState> {
  ...
  @override
  void didUpdateWidget(CalendarioState oldWidget) {
